...
exports.genshindb =(ver) => {
    return `*Command Genshin Database*
Version : ${ver}

${prefix}genshin <mode> <query pencarian>
${prefix}genshin <mode> <submode> <query pencarian>

Pilih salah satu mode di bawah ini
*character/chara*, *talent*, *constellation/(apa gitu)*, *weapon*, *material*, *artifact*, *food*, *domain*, *enemy*

Pilih salah satu submode di bawah ini
Character : 
  - ascend/cost : Melihat material ascend dari chara
  - stats : Melihat base stats chara berdasarkan level. 
            Contoh : ${prefix}genshin chara stats <level> <query pencarian>

Weapon : 
  - ascend/cost : Melihat material ascend dari weapon
  - stats : Melihat base stats weabon berdasarkan level. 
            Contoh : ${prefix}genshin weapon stats <level> <query pencarian>

Material :
  - more : Pencarian lebih detail

Talents : 
  - combat : Melihat talent combat dari chara
  - passive : Melihat talent passive dari chara
  - ascend : Melihat material ascend talent dari chara

Enemy :
  - stats : Melihat base stats weabon berdasarkan level. 
            Contoh : ${prefix}genshin enemy stats <level> <query pencarian>
`
}
